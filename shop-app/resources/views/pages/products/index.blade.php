                        ...
                        @forelse ($products as $key => $product)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <img src="{{ asset('storage/images/defaultIMG.png') }}" width="80">
                                    @endif
                ...
                <div class="modal-body">
                    <form id="createProductForm" action="{{ route('products.store') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="create_price" name="price" min="0"
                                required>
                        </div>
                        <div class="form-group">
        ...
        <div class="modal fade" id="editModal{{ $product->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editProductForm{{ $product->id }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="edit_category_id{{ $product->id }}" name="category_id"
                                    required>
                                    @foreach ($allCategories ?? [] as $category)
                            ...
                            <div class="form-group">
                                ...
                                @if ($product->image)
                                    <img src="{{ asset('storage/' . $product->image) }}" width="120" id="oldImage">
                                @endif
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                        <button type="submit" form="editProductForm{{ $product->id }}" class="btn btn-primary">Simpan
                            Perubahan</button>
                    </div>
                </div>
            </div>
