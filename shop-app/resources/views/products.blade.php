                        ...
                        <div class="modal-body">
                            <form action="updateProducts.php" method="POST" id="formUpdate<?= $d['id'] ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description<?= $d['id'] ?>" name="description" required><?= htmlspecialchars($d['description']) ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="categories_id<?= $d['id'] ?>" class="form-label">Kategori</label>
                                    <select class="form-control" id="categories_id<?= $d['id'] ?>"
